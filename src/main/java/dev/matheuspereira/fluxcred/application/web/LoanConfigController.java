...
public class LoanConfigController {
  ...
  @Operation(summary = "Get loan configuration by Identifier Type", description = "Returns loan configuration details for a given identifier type")
  @GetMapping("/{identifierType}")
  public ResponseEntity<LoanConfigResponse> getLoanConfig(@PathVariable String identifierType) {
