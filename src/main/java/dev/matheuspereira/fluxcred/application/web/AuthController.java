...
import dev.matheuspereira.fluxcred.application.data.request.AuthRequest;
import dev.matheuspereira.fluxcred.application.data.request.UserRegisterRequest;
